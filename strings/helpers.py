...
**ᴘᴏᴡʀᴇᴅ © ʙʏ** @Malayalam_Chatting_Links, @Malayalam_Chatting @Malayalam_Chatting_Links."""
...
/alive : ɴᴏᴡ ʏᴏᴜ ᴄᴀɴ ᴄʜᴇᴄᴋ ησɾα ᴍᴜsɪᴄ ʙᴏᴛ ɪs ᴀʟɪᴠᴇ ᴏʀ ɴᴏᴛ
/id : ᴛᴏ ᴄʜᴇᴋ ᴜsᴇʀ ᴀɴᴅ ᴄʜᴀᴛ ɪᴅ
/gcast -user -assistant -pin ᴛᴇsᴛɪɴɢ ʙʀᴏᴀᴅᴄᴀsᴛ`
/verify : ᴠᴇʀɪꜰʏ ʏᴏᴜʀsᴇʟꜰ ᴀᴛ ησɾα ᴅᴀᴛᴀʙᴀsᴇ
**ᴘᴏᴡʀᴇᴅ © ʙʏ** @Malayalam_Chatting_Links, @Malayalam_Chatting @Malayalam_Chatting_Links
"""
